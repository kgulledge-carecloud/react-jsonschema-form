    ...
    describe('JSONSchema validation', () => {
      ...
      describe('Min length', () => {
        ...
        it('should validate a minLength field', () => {
          expect(comp.state.errors).to.have.length.of(1);
          expect(comp.state.errors[0].message).eql('should NOT be shorter than 10 characters');
        });
        ...
        it('should trigger the onError handler', () => {
          sinon.assert.calledWith(
            onError,
            sinon.match(errors => {
              return errors[0].message === 'should NOT be shorter than 10 characters';
            })
          );
        });
      });
    ...
    describe('Custom Form validation', () => {
      ...
      it('should validate a simple object', () => {
        ...
        expect(comp.state.errorSchema).eql({
          ...
          pass2: {
            __errors: ['should NOT be shorter than 3 characters', "Passwords don't match"],
          },
        });
      });
      ...
      it('should validate an array of object', () => {
        ...
        const formData = [{ pass1: 'a', pass2: 'b' }, { pass1: 'a', pass2: 'a' }];
